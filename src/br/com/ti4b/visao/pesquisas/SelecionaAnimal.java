...
public class SelecionaAnimal extends javax.swing.JDialog {
    ...
    private int index = -1;
    private final TabelaAnimal tabelaAnimal = new TabelaAnimal();
     ...
     * @param modal
     */
    public SelecionaAnimal(java.awt.Frame parent, boolean modal, String query) {
        super(parent, modal);
        initComponents();
        povoarTabela(query);
    ...
    private void povoarTabela(String query) {
        if (query != null) {
            tabelaAnimal.inserirAnimals(new AnimalRN().retornaAnimalPorQuery(query));
        } else {
            tabelaAnimal.inserirAnimals(new AnimalRN().buscarTodos());
        }

        TabelaPesquisa.setModel(tabelaAnimal);
        TabelaPesquisa.getColumnModel().getColumn(0).setPreferredWidth(150);
        ...
        TabelaPesquisa.getColumnModel().getColumn(5).setPreferredWidth(300);
    }
    ...
    private void initComponents() {
        ...
        Classificacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "BOVÍNO", "CAPRÍNO", "SUÍNO", "OVÍNO" }));
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(RMorte, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public Animal getAnimal() {
        return index >= 0 ? tabelaAnimal.getAnimal(index) : null;
    }
}
